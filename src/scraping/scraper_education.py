...
logger = logging.getLogger("scraper_education")
...
def main():
    parser = argparse.ArgumentParser(description="PSA Education Scraper")
    parser.add_argument("--url", type=str, default="https://www.education.go.ke", help="Target URL to scrape")
    ...
    if args.output is None:
        ...
        output_path = os.path.join(project_root, "data", "raw", "scraped", "education.csv")
    else:
        output_path = args.output
        
    logger.info("=" * 60)
    logger.info("Starting Education Scraper")
    ...
    try:
        ...
        logger.info("Education Scraper execution completed successfully.")
    except Exception as e:
